...
Диагноз тогда звучал так: коду нужен свой конвейер — нарезка по функциям и классам вместо абзацев, и мостик от вопроса на русском к коду, который на русском не написан. Первая половина диагноза оказалась верной. Вторая — нет, и это главное, что стоит вынести из главы.

Коротко, чем всё кончилось:

* нарезка по определениям чинит фрагменты — и это работает ровно так, как ожидалось;
* **карточка фрагмента моста не построила.** Русский вопрос без единого слова из кода достаёт нужное определение 1 раз из 12 — и с карточкой, и без неё;
* мост построило другое: переписывание вопроса моделью перед поиском, 1 из 12 → **6–7 из 12**;
...
Единица из двенадцати — это не «стало хуже», это «не изменилось». Если посмотреть, на каком месте нужное определение оказывается во всей выдаче, а не только в первой пятёрке, медиана — **88-е место из 235**, разброс от 4-го до 158-го. Мост не построился.
