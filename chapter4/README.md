...
Индекс лежит в **ChromaDB**: папка `chroma_db/`, коллекция `chapter4_docs`. Векторы хранятся бинарно, запись инкрементальная, поверх коллекции строится HNSW-индекс.
