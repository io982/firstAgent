...
**Поиск всегда.** Классический конвейер «найти → подложить → ответить»: фрагменты приезжают в контекст до того, как модель увидела вопрос.

Мы хотели первое. Замер на пяти вопросах, ответы на которые есть в базе знаний:

| Режим | Позвал поиск | Ответил верно |
| :--- | :--- | :--- |
| Поиск как инструмент | 3 из 5 | **2 из 5** |
| Поиск всегда | всегда | **4 из 5** |
