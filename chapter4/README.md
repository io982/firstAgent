...
Размер — 600 символов, примерно 300 токенов. Это два-три абзаца: законченная мысль вместе с контекстом вокруг неё. На примерах в главе (папка docs) получается 31 фрагмент, от 178 до 577 символов, в среднем 474.
