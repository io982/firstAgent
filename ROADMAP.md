...
Перед созданием агента разбираемся, что такое модели, чем они отличаются и как выбирать модель под задачу и имеющееся железо.
...
* Total parameters
* Active parameters
* Почему MoE может быть эффективнее
...
* Q4_K_M
* Q5_K_M
* Качество vs память vs скорость
...
* Quantized models
* LoRA
* Как найти модель, которой нет в Ollama Library
* Как запускать GGUF через Ollama

## 0.10. Выбор модели

* Какая модель нужна для ReAct
* Какая для tool calling
* Какая для RAG
* Какая для coding
* Какая для reasoning
* Какая для vision
* Как тестировать модели на своей задаче
...
Цель — научиться строить систему, которая работает даже без мощной GPU.
