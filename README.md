...
| Глава | О чём |
|---|---|
| 7 | Гибридный поиск: почему одних векторов для кода мало |
...
4. **Замер качества поиска.** Расширьте `chapter6/test_search.py` своим набором
   запросов и посчитайте, в скольких случаях нужный файл попал в топ-3.
   Это заготовка для главы 7.
...
> **Готовы главы:** 1–6. План дальнейших — [ROADMAP.md](ROADMAP.md)
