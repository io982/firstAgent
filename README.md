...
| [Глава 6](chapter6/README.md) | Гибридный поиск: BM25 рядом с векторами, слияние выдач, реранкер и порог «в проекте этого нет» | [chapter6/agent.py](chapter6/agent.py) |
...
# Главы 4-6 — нужна модель эмбеддингов: ollama pull nomic-embed-text
...
graph TD
    ...
    Ch5 --> Ch6["chapter6<br/>+ лексический индекс BM25 рядом с векторным,<br/>слияние выдач по местам и реранкер на LLM,<br/>порог «в проекте этого нет», точное вхождение grep_code"]
```
