...
| [Глава 8](chapter8/README.md) | Кодинг-агент: план с подтверждением, правка по карте функций, проверка запуском и откат неудачи | [chapter8/agent.py](chapter8/agent.py) |
