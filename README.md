...
graph TD
    ...
    Ch7 --> Ch8["chapter8<br/>+ запись в файлы, запуск команд и границы вокруг них,<br/>конвейер из девяти узлов с планом и подтверждением,<br/>правка по карте функций, проверка линтером и откат по снимку git"]
```
