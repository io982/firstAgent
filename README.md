...
* General-purpose. Универсальные модели. 
> Подходят для: диалога; анализа текста; суммаризации; простых агентов; tool calling.
...
[«Своя сборка из GGUF»](#своя-сборка-из-gguf) сказано
