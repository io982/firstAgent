...
> это добавлять, описано в [в_разработке.md](в_разработке.md).
...
# отдельной главой — см. в_разработке.md
...
> **Готовы главы:** 1–6. План дальнейших — [в_разработке.md](в_разработке.md)
