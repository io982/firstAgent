...
**Дальше по плану:** поиск по кодовой базе, гибридный поиск,
...
| `search_docs`, индексация | 4 | Прочитать все `.md`, `.txt`, `.rst` в `chapter4/docs` (или в папке из `AGENT_DOCS_DIR`) и **отправить их текст в Ollama** для подсчёта векторов. Векторы вместе с текстом фрагментов ложатся в `chapter4/index/` |
