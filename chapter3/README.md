...
Писать такого агента руками не обязательно. Вибирите себе ИИ-помощника, который вам удобен.

Вот пример запроса(промта), чтобы получился агент на основе этого курса:
