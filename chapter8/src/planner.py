...
Пять задач правки, план от `qwen2.5:3b` — 4 зелёных прогона из 5
за 149 секунд; план из трёх шагов, собранный кодом, — 5 из 5 за 17.
Причина видна в отчёте замера: претензии к самому плану — выдуманный
путь, отсутствующий шаг — в 3 планах модели из 5, а план, в котором
нечего исполнять или в котором путь придуман, исполнить нельзя.
...
# 4 зелёных прогона из 5 за 149 с, а план из трёх шагов без всякой
# модели — 5 из 5 за 17 с. Причина видна в соседней колонке отчёта:
# претензии к самому плану (выдуманный путь, отсутствующий шаг) —
# в 3 планах модели из 5. План, в котором нечего исполнять или в
# котором путь придуман, исполнить нельзя.
#
# Тот же замер говорит и то, что приятно было бы не заметить: работа
# ВООБЩЕ БЕЗ ПЛАНА, когда файл назван в задаче, тоже даёт 5 из 5.
# План здесь нужен не для качества правки, а для того, чтобы человеку
# было что подтвердить до того, как файл изменён.
#
