...
757 быстрых тестов, живой модели не требуют (один пропускается на Windows без прав на символические ссылки). Отдельно — 10 проверок на живой модели (`-m integration`) и 10 замеров главы (`-m slow -s`); и те, и другие по умолчанию не выбираются.
